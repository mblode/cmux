            ...
            HStack(alignment: .top, spacing: 8) {
                ...
                if isEditing {
                    SidebarInlineRenameField(
                        ...
                        fontSize: GlobalFontMagnification.scaledSize(scaledFontSize(12), percent: globalFontMagnificationPercent), textColor: selectedWorkspaceForegroundNSColor(opacity: 1.0),
                        accessibilityLabel: String(
